...
## 6. Antarmuka (UI) Dashboard Warga & Layanan Surat
* Dibuat Layout UI berbasis **Bootstrap 5** yang modern dan *mobile-friendly* di **[warga.php](file:///d:/vibe-coding/sipelayan-desa/app/Views/layouts/warga.php)**.
* Diimplementasikan **[DashboardController.php](file:///d:/vibe-coding/sipelayan-desa/app/Controllers/Warga/DashboardController.php)** beserta view **[dashboard/index.php](file:///d:/vibe-coding/sipelayan-desa/app/Views/warga/dashboard/index.php)** yang memuat shortcut layanan, notifikasi, dan informasi desa terbaru.
* Diimplementasikan alur pengajuan **Surat Keterangan Domisili** pada **[PermohonanController.php](file:///d:/vibe-coding/sipelayan-desa/app/Controllers/Warga/PermohonanController.php)** beserta view formulir dinamis **[buat.php](file:///d:/vibe-coding/sipelayan-desa/app/Views/warga/permohonan/buat.php)** dan daftar riwayat permohonan **[index.php](file:///d:/vibe-coding/sipelayan-desa/app/Views/warga/permohonan/index.php)**.

## 7. Pengujian Keamanan (Security Testing)
* Dibuat rangkaian *Unit Tests* (menggunakan PHPUnit bawaan CodeIgniter 4) untuk menguji seluruh mekanisme perlindungan keamanan *Filter*. File yang ditambahkan:
  - **[AuthFilterTest.php](file:///d:/vibe-coding/sipelayan-desa/tests/Filters/AuthFilterTest.php)**: Menguji proteksi session.
  - **[RoleFilterTest.php](file:///d:/vibe-coding/sipelayan-desa/tests/Filters/RoleFilterTest.php)**: Menguji isolasi hak akses level pengguna (RBAC).
  - **[TenantFilterTest.php](file:///d:/vibe-coding/sipelayan-desa/tests/Filters/TenantFilterTest.php)**: Menguji skenario kebocoran akses data lintas-desa (Multi-Tenant).
  - **[RateLimitFilterTest.php](file:///d:/vibe-coding/sipelayan-desa/tests/Filters/RateLimitFilterTest.php)**: Menguji algoritma *Sliding Window* pada pembatasan jumlah *request*.
* Telah dipastikan **semua (13/13) test case lolos pengujian** pada environment *testing* yang dikontrol secara terisolasi.
