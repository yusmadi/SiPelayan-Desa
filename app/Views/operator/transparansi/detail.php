...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3 no-print">
    <div>
        <a href="<?= base_url('operator/transparansi') ?>" class="btn btn-sm btn-outline-secondary mb-2">
            <i class="bi bi-arrow-left me-1"></i> Kembali ke Daftar
        </a>
        <h2 class="h3 font-weight-bold mb-0">Pratinjau Dokumen Transparansi <?= $istilah ?></h2>
    </div>
    <div class="d-flex gap-2">
        <button onclick="window.print()" class="btn btn-outline-secondary">
            <i class="bi bi-printer me-1"></i> Cetak Lembar Infografis
        </button>
        <a href="<?= base_url('operator/transparansi/edit/' . $anggaran['id']) ?>" class="btn btn-primary">
        ...
        <div class="card border-0 shadow-sm p-4 p-md-5 bg-white rounded-4">
            ...
            <div class="mb-4">
                <h6 class="fw-bold text-dark text-uppercase border-bottom pb-2 mb-3">
                    <i class="bi bi-pie-chart text-primary me-2"></i>Rincian Realisasi Belanja per Bidang
                </h6>
