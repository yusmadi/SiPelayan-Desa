...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <h2 class="h4 fw-bold mb-0">Tambah Kabupaten / Kota Baru</h2>
    </div>
...
<div class="row justify-content-center">
    <div class="col-lg-6">
        <div class="card bg-white p-4 shadow-sm border-0">
            <form action="<?= base_url('super-admin/kabupaten/tambah') ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kode_kemendagri" class="form-control <?= (isset($validation) && $validation->hasError('kode_kemendagri')) ? 'is-invalid' : '' ?>" placeholder="Contoh: 33.02" value="<?= old('kode_kemendagri') ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama" class="form-control <?= (isset($validation) && $validation->hasError('nama')) ? 'is-invalid' : '' ?>" placeholder="Contoh: Kabupaten Banyumas" value="<?= old('nama') ?>" required>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary fw-semibold flex-grow-1">
                        <i class="bi bi-save me-1"></i> Simpan Kabupaten
                    </button>
