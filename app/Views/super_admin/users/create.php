...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="h4 fw-bold mb-1">Tambah Pengguna Baru</h2>
        <p class="text-muted mb-0">Tambahkan akun administrator atau operator desa baru.</p>
    </div>
    <div>
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card bg-white p-4 shadow-sm border-0">
            <form action="<?= base_url('super-admin/users/tambah') ?>" method="post">
                <?= csrf_field() ?>

                <div class="row g-3">
                    <div class="col-md-12">
                        <label class="form-label fw-semibold">Nama Lengkap <span class="text-danger">*</span></label>
                        <input type="text" name="nama_lengkap" class="form-control <?= (isset($validation) && $validation->hasError('nama_lengkap')) ? 'is-invalid' : '' ?>" placeholder="e.g. John Doe" value="<?= old('nama_lengkap') ?>" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" name="email" class="form-control <?= (isset($validation) && $validation->hasError('email')) ? 'is-invalid' : '' ?>" placeholder="user@desa.id" value="<?= old('email') ?>" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nik" class="form-control <?= (isset($validation) && $validation->hasError('nik')) ? 'is-invalid' : '' ?>" placeholder="16 digit NIK" maxlength="16" value="<?= old('nik') ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" name="password" class="form-control <?= (isset($validation) && $validation->hasError('password')) ? 'is-invalid' : '' ?>" placeholder="Minimal 8 karakter" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-check form-switch mt-3">
                            <input class="form-check-input" type="checkbox" name="is_nik_verified" id="is_nik_verified" value="1" <?= old('is_nik_verified') ? 'checked' : '' ?>>
