...
class PermohonanController extends BaseController
{
    public function index()
    {
        ...
        return view('admin_desa/permohonan/index', [
            'title'      => 'Approval Permohonan Surat - SiPelayan Desa',
    ...
    public function approve(int $id)
    {
        ...
        return redirect()->back()->with('success', 'Permohonan surat berhasil disetujui.');
    }
    ...
    public function reject(int $id)
    {
        $db = \Config\Database::connect();
        $villageId = (int) session('village_id');
        $alasan = $this->request->getPost('alasan_penolakan') ?? $this->request->getPost('catatan_penolakan') ?? 'Syarat dokumen belum lengkap';
    ...
    public function generate(int $id)
    {
        ...
        if (! $permohonan) {
            return redirect()->to('/admin-desa/permohonan')->with('error', 'Data permohonan surat tidak ditemukan.');
        }
